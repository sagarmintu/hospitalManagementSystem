        ...
        <table class="table table-bordered text-center">
            <thead>
                <tr style="background-color: #000;">
                    <th style="padding: 10px; font-size: 18px; color: #fff;">Doctor</th>
                    <th style="padding: 10px; font-size: 18px; color: #fff;">Date</th>
                    <th style="padding: 10px; font-size: 18px; color: #fff;">Message</th>
                    <th style="padding: 10px; font-size: 18px; color: #fff;">Status</th>
                    <th style="padding: 10px; font-size: 18px; color: #fff;">Cancel Appointment</th>
                </tr>
            </thead>
            <tbody>
